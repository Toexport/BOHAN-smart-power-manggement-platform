...
- (MarqueeView *)marqueeView{
    if (!_marqueeView) {
        MarqueeView * marqueeView =[[MarqueeView alloc]initWithFrame:CGRectMake(40, 0, ZP_Width, 50) withTitle:@[@"一小时内温度-99度,以上报告超过10次",@"桩点故障5次,以上报告超过5次",@"充电故障10次,以上报告超过15次",@"设备离线异常10次,以上报告超过8次",@"充电故障5次,以上报告超过7次"]];
