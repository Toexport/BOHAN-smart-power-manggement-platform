...
#import "ZPPuzzleVerifyView.h"
#import "UIBezierPath+ZPPuzzlePathMaker.h"
@interface ZPPuzzleVerifyView()
...
- (UIBezierPath *)pathForStyle:(ZPPuzzleVerifyStyle)style
{
    switch (style) {
        ...
        case ZPPuzzleVerifyStyleSquare:
            return [self squarePuzzlePath];
        case ZPPuzzleVerifyStyleCircle:
            return [self circlePuzzlePath];
        case ZPPuzzleVerifyStyleCustom:
            return nil;
    }
}
...
- (UIBezierPath *)classicPuzzlePath
{
    ...
    dispatch_once(&onceToken, ^{
        classicPath = [UIBezierPath bezierPathWithPathMaker:^(ZPPuzzlePathMaker * _Nonnull maker) {
