...
@property (nonatomic,strong, readwrite) ESPUDPSocketServer *_server;
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                if (receiveOneByte == expectOneByte)
                {
                    ...
                    if (timeout < 0)
                    {
                        ...
                        if (self._esptouchDelegate && [self._esptouchDelegate respondsToSelector:@selector(onEsptouchTimeout)]) {
                            
                            [self._esptouchDelegate onEsptouchTimeout];
                        }
                        if (DEBUG_ON)
                        {
                ...
                else
                {
                    if (receiveData == nil) {
                        ...
                        //                    [self __putEsptouchResultIsSuc:NO AndBssid:nil AndInetAddr:nil];
                        
                    }
                    //                else
                    //                {
                    //
                    //                    if (self._esptouchDelegate && [self._esptouchDelegate respondsToSelector:@selector(onEsptouchPasswordError)]) {
                    //
                    //                        [self._esptouchDelegate onEsptouchPasswordError];
                    //                    }
                    //
                    //                }
                    if (DEBUG_ON)
